    ...
    <header className="w-100 min-vh-100 d-flex align-items-center">
      <Container>
        <Row className="header-box d-flex align-items-center">
          ...
          <p className="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati praesentium rerum ab. Porro, vel omnis!</p>
            ...
            return (
               ...
               <div className="ket d-flex justify-content-between align-items-center px-3 pb-3">
                ...
                <button className="btn btn-danger rounded-1" onClick={() => {
                  setItemSelected(kelas); navigate('/checkout');}}>{kelas.buy}</button>
               </div>
               </Col>
            );
          })}
